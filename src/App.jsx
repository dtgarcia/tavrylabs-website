...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-t from-[#0B1D24] via-[#050505] to-black text-white font-sans">
      {/* Header */}
...
<section className="flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-16 gap-8">
  ...
  {/* Logo Bubble */}
  <div className="w-80 h-80 bg-zinc-800 clip-hexagon flex items-center justify-center overflow-hidden border-4 border-arcblue shadow-arc-glow animate-pulse">
  <img
